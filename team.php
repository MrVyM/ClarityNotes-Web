...
<div class="founder">
	...
	<ul class="list-inline social-links">
		...
		<li class="list-inline-item"><a href="https://www.instagram.com/romainvltgr"><i class="ti-instagram"></i></a></li>
	</ul>
</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="section-title">
					...
					<p>L'équipe de développement de ClarityNotes est composée de :</p>
				</div>
			</div>
		</div>
		<div class="row">
